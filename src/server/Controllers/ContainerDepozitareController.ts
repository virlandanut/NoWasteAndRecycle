...
export async function adaugaContainerDepozitare(
  request: Request,
  response: Response
) {
  const {
...
export async function getContainerDepozitare(
  request: Request,
  response: Response
) {
...
export async function getInchirieriContainerDepozitare(
  request: Request,
  response: Response
) {
  const id = parseInt(request.params.id);
...
export async function getRecenzieContainerDepozitare(
  request: Request,
  response: Response
) {
...
export async function getRatingContainerDepozitare(
  request: Request,
  response: Response
) {
  const id: number = parseInt(request.params.id);
...
export async function getRecenziiContainerDepozitare(
  request: Request,
  response: Response
) {
  const id: number = parseInt(request.params.id);
