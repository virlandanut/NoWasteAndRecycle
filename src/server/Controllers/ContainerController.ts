...
export async function getContainere(request: Request, response: Response) {
...
export async function getContainer(request: Request, response: Response) {
  const id: number = parseInt(request.params.id);
  const container: ContainerCuPret | null = await getContainerCuIstoricPret(id);
  if (!container) {
    return response
      .status(404)
...
export async function getStatusContainer(request: Request, response: Response) {
  const id: number = parseInt(request.params.id);
...
export async function updateStatusCon(request: Request, response: Response) {
...
export async function updateContainer(request: Request, response: Response) {
...
export async function deleteContainer(request: Request, response: Response) {
...
export async function filtrareContainere(request: Request, response: Response) {
  const {
    capacitate,
    tip,
    coordonate,
...
export async function getContainerePortal(
  request: Request,
  response: Response
) {
...
export async function getContainereSaptamana(
  request: Request,
  response: Response
) {
