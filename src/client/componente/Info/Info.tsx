  ...
  return (
    <div className="flex flex-col">
      ...
      <div
        ...
        <div
          className={`w-[${width}] text-sm text-black font-semibold bg-white shadow-md text-center p-4 border rounded-lg transition-all ease-in duration-75 top-[10px] absolute ${afisareInfo ? "translate-y-3 opacity-100" : "-translate-y-3 opacity-0 "}`}>
          {text}
