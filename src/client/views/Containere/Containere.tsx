...
export default function Containere() {
  ...
  const [tipContainerPersoana, setTipContainerPersoana] =
      ...
      <>
        ...
        utilizatorCurent.rol === "FIRMA" ? (
          <main className="min-w-screen min-h-screen flex justify-center p-10">
            <div className="w-full bg-[#f8f9fa] flex justify-center">
              <section className="w-full flex-col items-center shadow-sm md:flex">
                <div className="w-full flex justify-center">
                  <ToggleContainerFirma
                    setTipContainer={setTipContainerFirma}
                  />
                </div>
